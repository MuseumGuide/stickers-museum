...
public class CustomFontTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    private Typeface selectTypeface(Context context, int textStyle) {
        switch (textStyle) {
            case Typeface.BOLD:
                return FontCache.getTypeface("Aileron-SemiBold.otf", context);

            case Typeface.ITALIC:
                return FontCache.getTypeface("Aileron-Italic.ttf", context);

            case Typeface.BOLD_ITALIC:
                return FontCache.getTypeface("Aileron-SemiBoldItalic.otf", context);

            case Typeface.NORMAL:
            default:
                return FontCache.getTypeface("Aileron-Light.otf", context);
        }
    }
